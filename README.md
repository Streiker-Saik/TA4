...
- ### Основа:
  ...
  - #### BaseService:
    ...
    Методы:
    - add - Создание нового объекта
    - find_by_id - Получение объекта по ID
    - update - Изменение объекта по ID
    - delete - Удаление объекта по ID
    - find_one_or_none - Получение одного объекта
    - find_all - Получение всех объектов
